...
We will use the `apartments` dataset from `DALEX2` package.
...
We will use `localModel` and `DALEX2` packages, random forest from `randomForest` package will serve as an example model.
